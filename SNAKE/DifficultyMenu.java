...
public class DifficultyMenu extends JFrame {
    ...
    DifficultyMenu() {
        ...
        EventHandler normalHandler = new EventHandler(100, "normalfruit.png");
        ...
        EventHandler handler3 = new EventHandler(40, "expertfruit.png");
        ...
        EventHandler handler4= new EventHandler(10, "godmodefruit.png");
